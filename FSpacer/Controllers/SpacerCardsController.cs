...
namespace FSpacer.Controllers
{
    public class SpacerCardsController : Controller
    {
        ...
        public IActionResult SearchSpacerCards()
        {
            return View();
        }
        ...
        public async Task<IActionResult> SearchResults(SearchInputModel search)
        {
            ...
            var spacercards = await _context.SpacerCards.ToListAsync();

            var filtered = spacercards.Where(s => s.DriveNumber == search.SearchDriveNumber);
